  ...
  if (success) {
    return (
      <div className="space-y-4 py-8 text-center">
        ...
        <p className="text-slate-400 text-sm">Welcome to EduAgent! Redirecting you...</p>
      </div>
    );
  }
  ...
  return (
    <div className="space-y-6">
      ...
      <form className="space-y-4" onSubmit={handleSubmit}>
        ...
        <Button className="w-full h-11 bg-white text-slate-950 hover:bg-slate-200" type="submit" disabled={loading || !ready}>
